...
public class HistoricalDataService {
    ...
    public void getOneMinBars(LocalDate startingDate){
        ...
        while(!startingDate.equals(LocalDate.now())){
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create("https://data.alpaca.markets/v1/bars/1Min?symbols=AAPL&limit="+limit+"&start="+startingDate+"&end"+endDate+"&after&until"))
